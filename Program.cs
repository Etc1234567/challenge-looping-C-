        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 2] == "Age: ?" && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
                        Console.WriteLine($"Pet {ourAnimals[i, 0]} is missing age information. Enter the pet's age.");
                        readResult = Console.ReadLine();
                ...
                if (ourAnimals[i, 4] == "Physical description: " && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
                        Console.WriteLine($"Pet {ourAnimals[i, 0]} is missing a physical description. Enter a physical description of the pet (size, color, gender, weight, housebroken)");
                        readResult = Console.ReadLine();
            ...
            Console.WriteLine("Thank you for updating the information. All pet age and physical description data is up to date.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 3] == "Nickname: " && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
                        Console.WriteLine($"Our pet {ourAnimals[i, 0]} is missing a nickname. Enter a nickname.");
                        readResult = Console.ReadLine();
                ...
                if (ourAnimals[i, 5] == "Personality: " && ourAnimals[i, 0] != "ID #: ")
                {
                    do
                    {
                        Console.WriteLine($"Our pet {ourAnimals[i, 0]} is missing a personality description. Enter a description of the pet's personality (likes or dislikes, tricks, energy level)");
                        readResult = Console.ReadLine();
            ...
            Console.WriteLine("Thank you for updating this information. Nickname and personality have been added.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
